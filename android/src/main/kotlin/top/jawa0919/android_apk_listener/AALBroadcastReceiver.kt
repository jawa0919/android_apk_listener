...
class AALBroadcastReceiver(private val activity: Activity) : BroadcastReceiver(),
    EventChannel.StreamHandler {
    private val TAG = "AALBroadcastReceiver"
    ...
    override fun onListen(arguments: Any?, events: EventChannel.EventSink?) {
        Log.i(TAG, "AALBroadcastReceiver onListen")
    ...
    override fun onCancel(arguments: Any?) {
        Log.i(TAG, "AALBroadcastReceiver onCancel")
