...
class AALMethodCallHandler(
    private val activity: Activity, private val manager: PackageManager
) : MethodChannel.MethodCallHandler {

    private val TAG = "AALMethodCallHandler"
    private var receiver: AALBroadcastReceiver? = null
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        when (call.method) {
            ...
            "startPackageInfoChangeListen" -> {
                ...
                receiver = AALBroadcastReceiver(activity)
